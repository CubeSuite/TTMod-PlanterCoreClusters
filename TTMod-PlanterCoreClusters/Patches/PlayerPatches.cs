...
namespace TTMod_PlanterCoreClusters.Patches
{
    ...
    internal class PlayerPatches
    {
        ...
        public static bool Awake_Prefix(Player __instance) {
            TTMod_PlanterCoreClustersPlugin.Log.LogInfo("In Player Awake method Prefix.");
            return true;
        }
        ...
        public static void Awake_Postfix(Player __instance) {
            TTMod_PlanterCoreClustersPlugin.Log.LogInfo("In Player Awake method Postfix.");
        }
    }
}